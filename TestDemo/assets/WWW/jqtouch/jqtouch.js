...
(function($) {
    $.jQTouch = function(options) {
        ...
        function clickHandler(e) {
            //console.log('jqtouch--clickhandler---'+1);
            _debug();
       ...
       // console.log('jqtouch----mousedownhandler----1');
		...
		//alert(hash.toString());
			...
			//add by pengjuxiang  old:hash = hash.replace(/^#/, ''),
...
*/
        ...
        //console.log('jqtouch-----taphandler-----1');
            _debug();
	...
	//		console.log('-----------------isExternalLink   #-----------------');
        ...
        //console.log('jqtouch-----touchstarthandler----1');
            _debug();
            ...
            function touchMoveHandler(e) {
                if(window.console){
                   //console.log('events:jqtouch touch move handler.');
                }
                // _debug();
                updateChanges();
		...
		//	console.log('------before initialPageId-------------');
            setHash(initialPageId);
		//	console.log('------end initialPageId-------------');
